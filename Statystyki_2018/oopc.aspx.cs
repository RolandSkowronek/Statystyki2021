...
namespace Statystyki_2018
{
    public partial class oopc : System.Web.UI.Page
    {
        ...
        protected void tabela_1()
        {
            ...
            GridViewBandColumn liczbaSporzadzonychUzasadnien = DevExpressXXL.podKolumna(new string[4] { "Łącznie", "w terminie ustawowym 14 dni", "w tym o rozwód", "w tym o separację" }, 65, idDzialu, false, szerokoscKolumny, "terminowość sporządzania uzasadnień na wniosek przez sędziów i referendarzy sądowych (zgodnie z MS - S1r, dz. 1.4.1.a + 1.4.1.c) * ");
